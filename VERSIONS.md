...
| 0.32.1 | `Dockerfile` | [GitHub Releases](https://github.com/ollama/ollama/releases) |
...
| 2026-07-20 | Ollama | 0.30.10 | 0.32.1 | Automated update |
|------|-----------|-------------|-------------|-------|
| 2026-06-22 | Ollama | 0.13.5 | 0.32.1 | Manual catch-up bump (auto-update workflow was blocked) |
